...
#define __NOP                                     __no_operation            /*!< no operation intrinsic in IAR Compiler */ 
            ...
            uint32_t PreemptPriority, uint32_t SubPriority)
    {
        ...
        return (((PreemptPriority & ((1 << (PreemptPriorityBits)) - 1))
                << SubPriorityBits) | ((SubPriority & ((1 << (SubPriorityBits))
                - 1))));
    }
    ...
    {
        SCB->AIRCR = ((0x5FA << SCB_AIRCR_VECTKEY_Pos) | (SCB->AIRCR
                & SCB_AIRCR_PRIGROUP_Msk) | SCB_AIRCR_SYSRESETREQ_Msk); /* Keep priority group unchanged */
